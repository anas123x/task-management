...
const ViewTasksComponent: React.FC<ViewTasksComponentProps> = ({
  tasks,
  deleteTask,
}) => {
          ...
          <div className="mx-auto flex flex-col items-center py-20">
            ...
            >
              ...
              <path
                ...
                stroke="#81E6D9"
              />
              <circle cx="60.2069" cy="61" r="21.0256" fill="#E6FFFA" />
              <path
              ...
              <rect
                ...
                fill="#38B2AC"
              />
              <circle cx="42.2582" cy="23.5641" r="1.02564" fill="#38B2AC" />
              <circle cx="46.3607" cy="23.5641" r="1.02564" fill="#38B2AC" />
              <circle cx="50.4633" cy="23.5641" r="1.02564" fill="#38B2AC" />
            </svg>
           <span className="text-teal-600 font-light text-lg">No tasks to show</span> 
          </div>
        )}
      </div>
    </div>
